...
function Signup() {
  ...
  return (
    <><Navbar />
    <div className='min-h-screen relative flex flex-col  justify-center overflow-hidden pt-20 lg:pt-28 bg-white py-6 sm:py-12'>
        ...
        <div className='basis-1/3 flex-1  '>
          ...
          <div className='mt-5'>
            <form action="">
              ...
              <div className='relative mt-6'>
                <input type="password" name='password' id='password' placeholder='Password' className='peer mt-1 w-full border-b-2 border-gray-300 px-0 py-1 placeholder:text-transparent focus:border-gray-500 bg-white  focus:outline-none' />
                <label htmlFor="password" className='pointer-events-none absolute top-0 left-0 origin-left -translate-y-1/2 transform text-sm text-gray-800 opacity-75 transition-all duration-100 ease-in-out peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-500 peer-focus:top-0 peerr-focus:pl-0 peer-focus:text-sm peer-focus:text-gray-800'>Confirm Password</label>
              </div>
              <div className="my-6">
              ...
              <p className="text-center text-sm text-gray-500">Already having an account? <a href="#!" className="font-semibold text-gray-600 hover:underline focus:text-gray-800 focus:outline-none" onClick={() => router.push('/login')}>log in</a>.</p>
              <p className='text-center text-sm text-gray-500'>or</p>
              <div className='flex gap-5 justify-center mt-2'>
                <button className='text-sm flex bg-black h-8 text-white p-2 font-semibold rounded-md cursor-pointer'><FcGoogle className='text-lg align-middle mr-1 ' />Register with Google</button>
