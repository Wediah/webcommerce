  ...
  return (
    <Element id="contact" name="contact">
        <div className='min-h-screen bg-white'>
            ...
            <form className='flex flex-col items-center float-left bg-gray-300 rounded-3xl mx-20 mt-10' onSubmit={handleSubmit}>
            ...
            <div className=" gap-5 lg:flex mt-10 px-10 pb-10">
                  <div className='flex-row bg-yellow-500'>
                    <div className="shadow-2xl rounded-3xl text-center p-2  flex-1 w-80 bg-slate-300 mt-5">
