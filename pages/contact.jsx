        ...
        <div className='min-h-screen bg-white px-10 pt-40 pb-5'>
            ...
            <div className='lg:flex gap-5 pb-5 rounded-lg justify-center items-center mx-80 bg-white shadow-2xl'>
              ...
              <div className="flex-col text-black gap-5">
                ...
                <div className="mt-2">
                  <h4 className="text-md font-semi-bold flex items-center"><CiLocationOn/>Accra, Ghana</h4>
                </div>
                <div className="mt-2">
                  <a href=""><h4 className="text-md font-semi-bold flex items-center"><CgMail/>infoE&M@gmail.com</h4></a>
                </div>
                <div className="mt-2">
